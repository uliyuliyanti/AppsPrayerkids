...
public class AdminProductItem {

    public AdminProductItem() {
    }
    public AdminProductItem(String productId, String harga, String kategori, String namaProduk, String diskon, String terjual, String keyId, List<String> img) {
