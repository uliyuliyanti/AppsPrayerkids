...
import static com.prayerkidsstore.AdminApproveUser.userName;
...
import com.prayerkidsstore.AdminApproveUserDetails;
...
public class AdminApproveAdapter
extends RecyclerView.Adapter<AdminApproveAdapter.Myviewholder> {
    boolean solved = true;
    boolean showprogress = true;
    Context context;
    ArrayList<AdminApproveItem> myItem;
    int harga_total_plus = 0;
    int qty_total_plus = 0;
    double harga_total = 0.0;
    double diskon = 0.0;
    public AdminApproveAdapter(Context c, ArrayList<AdminApproveItem> p){
        context = c;
        myItem = p;
    }
...
//            }
        ...
        myviewholder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent product_details = new Intent(context, AdminApproveUserDetails.class);
                ...
                product_details.putExtra("user_name",userName);
    ...
    public void filterList(ArrayList<AdminApproveItem> filteredList) {
        myItem = filteredList;
