 ...
 *  java.util.Locale
 */
package com.prayerkidsstore.productHome;
...
extends RecyclerView.Adapter<ProductHomeAdapter.Myviewholder> {
    boolean solved = true;
    boolean showprogress = true;
    Context context;
    ArrayList<ProductHomeItem> myItem;
    int limit=10;
//    ArrayList<ProductItem> addPolistitem;
    public ProductHomeAdapter(Context c, ArrayList<ProductHomeItem> p){
        context = c;
        myItem = p;
    }
    ...
    public void filterList(ArrayList<ProductHomeItem> filteredList) {
        myItem = filteredList;
